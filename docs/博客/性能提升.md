...
![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/a4635b395fb64aaab8417f63e64291d4~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.awebp) CNAME（意为：别名）：在域名解析中，实际上解析出来的指定域名对应的IP地址，或者该域名的一个CNAME，然后再根据这个CNAME来查找对应的IP地址。
...
**图示：** ![img](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/efbcb31418be45eaa848d107b107c4eb~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.awebp) **代码实现：**

```javascript
javascript 体验AI代码助手 代码解读复制代码<div class="container">
...
```javascript
javascript 体验AI代码助手 代码解读复制代码function debounce(fn, wait) {
  var timer = null;
...
```javascript
javascript 体验AI代码助手 代码解读复制代码// 时间戳版
...
javascript
 ...
 体验AI代码助手
 代码解读
复制代码loader: 'babel-loader?cacheDirectory=true'
```
...
```javascript
javascript 体验AI代码助手 代码解读复制代码module: {
  loaders: [
    {
      test: /\.js$/,
      include: [resolve('src')],
...
```javascript
javascript 体验AI代码助手 代码解读复制代码// 单独配置在一个文件中
// webpack.dll.conf.js
...
```javascript
javascript 体验AI代码助手 代码解读复制代码// webpack.conf.js
module.exports = {
  // ...省略其他配置
  plugins: [
...
```javascript
javascript 体验AI代码助手 代码解读复制代码// test.js
export const a = 1
// index.js
